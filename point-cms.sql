...
--
-- Host: localhost
-- Generation Time: Sep 08, 2017 at 02:27 PM
...
INSERT INTO `settings` (`id`, `homepage_color`, `dashboard_color`, `website_name`, `website_description`, `author`, `email_address`, `footer_info`, `theme`) VALUES
(1, 'white', 'black', 'point-theme', 'point-theme', 'kostadinovski.me', 'this is the website desc', '<p>The Point CMS is completely free and open-source. You can download it on GitHub.</p>\n        <p>Made with <span class="icon icon-heart inverse-icon icon-heart-footer"></span> by @imstef, @imilosk</p>', 'point-theme');
...
(22, 'Point CMS', 'a lighweight CMS', 'This project is completely free and opensource. You can find it on GitHub.', '', 'html;css;js;python', '', 'github', 4, 1);
